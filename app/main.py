...
from app.routers import documents, stage1_extract, stage3_agent, stage4_report
...
app.include_router(stage1_extract.router, prefix="/api/v1/stage1", tags=["Full Pipeline"])
app.include_router(stage3_agent.router,   prefix="/api/v1/stage3", tags=["Risk Assessment"])
