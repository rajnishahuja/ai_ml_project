...
def node_report_generation(state: RiskAnalysisState):
    ...
    print(
        f"🔄 [NODE E | Stage 4 - Report] Aggregating {len(assessed_clauses)} assessed clauses..."
    )
    ...
    print(
        f"✅ [NODE E | Stage 4 - Report] Final report compiled. Risk score: {report['overall_risk_score']}"
    )
