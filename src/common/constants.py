"""
Constants for CUAD Inference.
Contains the schema and question templates required for DeBERTa span extraction.
"""
...
CUAD_QUESTION_TEMPLATES = {
    ...
    "Exclusivity": 'Highlight the parts (if any) of this contract related to "Exclusivity" that should be reviewed by a lawyer. Details: Is there an exclusive dealing commitment with the counterparty? This includes a commitment to procure all "requirements" from one party of the goods or services described in the contract.',
    "No-Solicit Of Customers": 'Highlight the parts (if any) of this contract related to "No-Solicit Of Customers" that should be reviewed by a lawyer. Details: Is there a restriction on a party\'s soliciting or targeting customers of the counterparty, whether during the contract or after the contract ends (or both)?',
    ...
    "ROFR/ROFO/ROFN": 'Highlight the parts (if any) of this contract related to "ROFR/ROFO/ROFN" that should be reviewed by a lawyer. Details: Is there a right of first refusal, right of first offer or right of first negotiation?',
    "Change Of Control": 'Highlight the parts (if any) of this contract related to "Change Of Control" that should be reviewed by a lawyer. Details: Does one party have the right to terminate or is consent or notice required of the counterparty if such party undergoes a change of control, such as a merger, acquisition, or sale of assets?',
    ...
    "Unlimited/All-You-Can-Eat-License": 'Highlight the parts (if any) of this contract related to "Unlimited/All-You-Can-Eat-License" that should be reviewed by a lawyer. Details: Is there a clause granting one party an unlimited usage license?',
    ...
    "Liquidated Damages": 'Highlight the parts (if any) of this contract related to "Liquidated Damages" that should be reviewed by a lawyer. Details: Does the contract contain a clause that would award either party liquidated damages for breach or a specific failure to perform?',
